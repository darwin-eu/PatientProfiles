...
In this example, `CohortConstructor` is used to create the ankle sprain cohort. PatientProfiles then adds table intersections to the resulting valid cohort table; it does not create or modify cohort definitions.
