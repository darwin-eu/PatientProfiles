...
- **Xihang Chen**. Contributor.
  [](https://orcid.org/0009-0001-8112-8959)

## Citation

Source:
[`DESCRIPTION`](https://github.com/darwin-eu/PatientProfiles/blob/v1.6.1_JOSS/DESCRIPTION)
...
Common Data Model*. R package version 1.6.1,
